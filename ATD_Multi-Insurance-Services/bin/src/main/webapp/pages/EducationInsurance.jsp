...
<html>
<head>
<title>Child Education Planning Calculator|Investment calculator
</title>
<meta charset="utf-8" />
<meta name="viewport"
...
<link
	href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600|Roboto:100,400"
	rel="stylesheet" />
<script defer
...
<link href="/webapp/css/educainsur" rel="stylesheet" />
<link rel="stylesheet"
...
<meta name="keywords"
	content="ULIP calculator,child plan,child education plan,Insurance Plan,sukanya samriddhi yojana" />
<meta name="description"
	content="Plan your child’s education. Child Education Planner is your guide to fund your child’s bright future" />
...
<script async
	src="https://www.googletagmanager.com/gtag/js?id=UA-136614031-3"></script>
<script>
...
<body>
				...
				<form method="post" action="Eduinsurdetails" id="frmwww">
					<div class="form-group row">
						<div class="col-md-6">
							...
							</span> <input name="Name" type="text" placeholder="Enter Name"
								class="form-control" />
						</div>
						<div class="col-md-6">
	...
	<script src="/Calculators/js/bsnav.min.js"></script>

	<script>
		AOS.init();
		$('.navbar-toggler').click(
				function() {
					$('.bsnav-mobile .navbar .masterbarmobile').html(
							$(".masterbar").html());
				});
	</script>
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/autonumeric/4.1.0/autoNumeric.min.js"></script>
	...
	<script>
		...
		//AutoNumeric.multiple('.CurrencyNew', { allowDecimalPadding: false, digitalGroupSpacing: "2", minimumValue: 0.1 , maximumValue: 50 });
		//anElement78.options.decimalPlaces = 0;
		AutoNumeric.multiple('.CurrencyMax', {
			allowDecimalPadding : false,
			digitalGroupSpacing : "2",
			minimumValue : 1,
	...
	<script>
		...
		$('.PerTxt').keyup(function(e) {
			if (e.which == 8) {
				var dd = $(this).val().replace('%', '');
				$(this).val(dd);
				return;
			}
